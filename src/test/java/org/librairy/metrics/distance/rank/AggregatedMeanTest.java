 ...
 * @author Badenes Olmedo, Carlos <cbadenes@fi.upm.es>
 */
public class AggregatedMeanTest {
    ...
    public void permutations(){
        ...
        AggregatedMean<String> wordsRankMeasure = new AggregatedMean<>();
    ...
    public void minimum(){
        ...
        Double distance = new AggregatedMean<String>().calculate(r1, r1);
    ...
    public void maximum(){
        ...
        Double distance = new AggregatedMean<String>().calculate(r1, r2);
