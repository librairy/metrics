...
public class HellingerSimilarityTest {
    ...
    public void emptyVector(){
        ...
        double result = HellingerSimilarity.apply(v1, v2);

        LOG.info("v1: " + v1);
        LOG.info("v2: " + v2);
        LOG.info("similarity: " + result);

        double div = HellingerDistance.apply(v1, v2);
    ...
    public void difference(){
        ...
        double result2 = HellingerSimilarity.apply(v1, v2);
        LOG.info("similarity: " + result2);

        double[] v3 = new double[]{0.3, 0.4, 0.2};
        double result3 = HellingerSimilarity.apply(v1, v3);
