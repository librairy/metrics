 ...
 *
 *   Based on:
 *   Kumar, R., & Vassilvitskii, S. (2010). Generalized distances similarity rankings.
 *   Proceedings of the 19th International Conference on World Wide Web - WWW ’10,
 *   (3), 571. http://doi.org/10.1145/1772690.1772749
 *
 */
public class ExtendedKendallsTau<T>  implements DistanceMeasure<Ranking<T>>, SimilarityMeasure<Ranking<T>> {
    ...
    public ExtendedKendallsTau(SimilarityMeasure<T> similarityMeasure) {
        this.similarityMeasure = similarityMeasure;
    }

    public Double distance(Ranking<T> r1, Ranking<T> r2){
